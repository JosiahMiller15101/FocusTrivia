<x-layout>
  ...
  <div class="flex items-center justify-center text-lg text-center px-4">
  <p>
    <strong>Welcome to FOCUS Trivia Your daily challenge begins here! Each day, sharpen your mind with a brand-new trivia question and see how you
