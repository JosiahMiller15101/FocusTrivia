...
<head>
    <meta charset="UTF-8">
    <title>419 Page Expired | FOCUS Trivia</title>
...
<body class="min-h-screen flex items-center justify-center bg-gray-800">
    ...
    <div class="bg-white/90 rounded-xl shadow-2xl px-10 py-12 max-w-lg w-full text-center">
        <h1 class="text-7xl font-extrabold text-slate-700 mb-4">419</h1>
        <p class="text-2xl font-bold text-slate-700 mb-2">Oops! Page expired.</p>
        <p class="text-slate-600 mb-6">The page you're looking for has expired.</p>
